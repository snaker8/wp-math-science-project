...
■ 난이도 (수학비서 기준, 1~10 스케일)
● 쉬움(1~2): 개념·정의만 알면 바로 풀림. 단순 용어, 기본 계산, 공식 직접 대입.
● 보통(3~4): 공식 1~2개 적용, 2~3단계 풀이. 기본 응용.
● 어려움(5~6): 2개 이상 개념 연결, 복합 조건, 자료 해석, 중간 난이도 서술형.
● 매우어려움(7~10): 고난도 추론, 복합 서술형, 여러 개념 융합, 함정/오개념 포함, 킬러 문항.

★ 문제 내용을 정확히 분석하여 1~10 중 하나를 배정하세요.
★ 서술형/서논술형은 최소 5 이상.
★ 합답형(ㄱㄴㄷ)은 최소 5 이상.
★ 배점이 높을수록(3점, 4점) 난이도 상향.

...
★★★ 난이도 배정 규칙 (필수 — 난이도 2에 몰리지 않도록):
1. 내신 시험지는 난이도 분포가 골고루여야 합니다:
   - 하(1): 약 15~20% — 개념 확인, 단순 계산 문제
   - 중하(2): 약 25~30% — 1개 개념 적용, 공식 대입
   - 중(3): 약 25~30% — 2개 이상 개념 연결, 자료 해석
   - 중상(4): 약 15~20% — 복합 조건, 서술형, 응용
   - 상(5): 약 5~10% — 고난도 추론, 최고난도 서술형
2. ★ 서술형/서논술형 문제는 최소 난이도 3 이상
3. ★ [N점] 배점이 높을수록 난이도가 높음 (3점=중상~상, 4점=상)
4. ★ 선택지가 복잡하거나 함정이 있으면 난이도 상향
5. ★ 합답형(ㄱㄴㄷ)은 최소 난이도 3 이상

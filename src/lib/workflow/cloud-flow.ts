...
- ★ 상용로그 활용 세부유형 구분: "N시간/N년 후 비율/배/배수" 답이 수치(예: 79.3배) → 거듭제곱 비율 계산 (자릿수 노드 X). "N자리 수/정수부분이 N자리/몇 자리 수" → 자릿수 노드. "N의 정수부분·소수부분" → 정수부분·소수부분 노드. "몇 배인가"가 본문에 있으면 자릿수 X, 거듭제곱 활용 우선.

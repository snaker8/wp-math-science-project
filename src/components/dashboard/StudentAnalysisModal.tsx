            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="fixed inset-0 bg-surface-base/60 backdrop-blur-xl z-[100]"
                    />
                    ...
                    <div className="fixed inset-0 z-[101] flex items-center justify-center pointer-events-none p-4">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between p-6 border-b border-subtle bg-surface-card/50">
                                ...
                                <button
                                    onClick={onClose}
                                    className="p-2 rounded-lg hover:bg-white/5 text-content-tertiary hover:text-content-primary transition-colors"
                                >
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                            ...
                            <div className="p-6 border-t border-subtle bg-surface-card/80 flex items-center justify-between">

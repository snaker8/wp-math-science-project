        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden selection:bg-white/20">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    className="absolute top-1/4 left-1/4 text-9xl font-bold text-white/5 blur-sm"
                >
                    404
                </motion.div>
                <motion.div
                ...
                <motion.div
                    ...
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-white/[.06] rounded-full blur-[100px]"
                />
            </div>
            ...
            <div className="relative z-10 text-center px-6">
                ...
                >
                    <div className="inline-flex items-center justify-center p-4 bg-white/[.04] rounded-full mb-8 ring-1 ring-white/[.14]">
                    ...
                    <h2 className="text-2xl md:text-3xl font-light text-zinc-300 mb-6 tracking-wide">
                        Undefined Coordinate
                    </h2>

                    <p className="text-zinc-400 max-w-md mx-auto mb-10 text-lg leading-relaxed">
                        요청하신 좌표는 현재 함수의 <span className="text-zinc-200 font-mono">domain</span>에 포함되어 있지 않습니다.<br />
                        경로를 재계산하여 이동해주세요.
                    </p>
            ...
            <div className="absolute bottom-8 text-center text-xs text-zinc-600 font-mono">
                Error Code: 0x194 | System Status: Stable | <Link href="/support" className="hover:text-zinc-300 underline decoration-zinc-700 underline-offset-4 transition-colors">Contact Support</Link>
            </div>
        </div>
    );
}

        ...
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-6" onClick={() => !busy && setApproving(null)}>
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl w-full max-w-md p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="text-xs text-zinc-400 mb-4 bg-zinc-900/50 rounded-lg p-3">
              ...
              신청 학원: <span className="text-amber-300 font-bold">{approving.proposed_organization_name}</span>
            </div>
            ...
            <div className="flex gap-1 bg-zinc-900 border border-zinc-800 rounded-lg p-1 mb-4">
              <button
                ...
                className={`flex-1 px-3 py-2 rounded text-xs font-semibold ${approveMode === 'new' ? 'bg-indigo-500 text-white' : 'text-zinc-500'}`}
              >
                신규 학원 생성
              </button>
              <button
                ...
                className={`flex-1 px-3 py-2 rounded text-xs font-semibold ${approveMode === 'existing' ? 'bg-indigo-500 text-white' : 'text-zinc-500'}`}
              >
                기존 학원에 배정
              </button>
            </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full mt-1 px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-sm text-white focus:border-indigo-500 focus:outline-none"
                  />
                </div>
                <div>
            ...
            <div className="mt-3">
              ...
              <textarea
                ...
                rows={2}
                className="w-full mt-1 px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-sm text-white focus:border-indigo-500 focus:outline-none resize-none"
              />
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-6" onClick={() => !busy && setRejecting(null)}>
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl w-full max-w-md p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 text-sm text-white focus:border-rose-500 focus:outline-none resize-none"
            />
